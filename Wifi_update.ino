...
void MCP4728_control()
{
    ...
    if (pin == 1){
        mcp.setChannelValue(MCP4728_CHANNEL_A, value * 16);
    }

    else if (pin == 2){
        mcp.setChannelValue(MCP4728_CHANNEL_B, value * 16);
    }

    else if (pin == 3){
        mcp.setChannelValue(MCP4728_CHANNEL_C, value * 16);
    }

    else if (pin == 4){
        mcp.setChannelValue(MCP4728_CHANNEL_D, value * 16);
    }
